...
Hhub = turbine_data.values[0,1]
# Rotor diameter
R = turbine_data.values[0,2]
D = R*2
#
...
zi_cut1 = np.linspace(VARxz_cut1[:,1].min(), VARxz_cut1[:,1].max(), KMAX+2)
...
textstr1 = '\n'.join((
    'Wind turbine n.1 :',
    r'$F_{T}=%.2f$ kN' % (THRUT[0]/1000, ),
    r'$\overline{F_{T}}=%.2f$ kN' % (THRUMME[0]/1000, )))
textstr2 = '\n'.join((
    'Wind turbine n.2 :',
    r'$F_{T}=%.2f$ kN' % (THRUT[1]/1000, ),
    r'$\overline{F_{T}}=%.2f$ kN' % (THRUMME[1]/1000, )))
props = dict(boxstyle='round', facecolor='wheat', alpha=0.5)
ax_cut3.text(0.05, -0.8, textstr1,transform=ax_cut3.transAxes, fontsize=14,
        verticalalignment='top', bbox=props)
ax_cut3.text(0.05, -1.3, textstr2,transform=ax_cut3.transAxes, fontsize=14,
        verticalalignment='top', bbox=props)
