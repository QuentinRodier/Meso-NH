...
Dvar_input = {'f1':[('/Budgets/RI','AVEF'),('/Budgets/RR','AVEF'),('/Budgets/RS','AVEF'),('/Budgets/RG','AVEF'),('/Budgets/RC','AVEF'),
                     ...
                     ('/Budgets/RC','SEDI'), ('/Budgets/RC','DEPI'), ('/Budgets/RC','BERFI'), ('/Budgets/RC','IMLT'),
                     ('/Budgets/RR','AUTO'), ('/Budgets/RR','ACCR'), ('/Budgets/RR','REVA'), ('/Budgets/RR','DRYG'),
                     ('/Budgets/RR','GMLT'), ('/Budgets/RR','ACC'),
                     ('/Budgets/RI','AGGS'), ('/Budgets/RI','AUTS'), ('/Budgets/RI','CFRZ'), ('/Budgets/RI','IMLT'),
                     ('/Budgets/RI','DEPI'), ('/Budgets/RI','BERFI'),
                     ('/Budgets/RS','AGGS'), ('/Budgets/RS','AUTS'), ('/Budgets/RS','ACC'), ('/Budgets/RS','CMEL'),
                     ('/Budgets/RS','DEPS'), ('/Budgets/RS','RIM'), ('/Budgets/RS','DRYG'),
                     ('/Budgets/RG','DEPG'), ('/Budgets/RG','ACC'), ('/Budgets/RG','CFRZ'), ('/Budgets/RG','CMEL'),
...
Lplot = [Dvar['f1'][('/Budgets/RC','AUTO')][nmask,ntime,:], Dvar['f1'][('/Budgets/RC','ACCR')][nmask,ntime,:], Dvar['f1'][('/Budgets/RC','RIM')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RC','DRYG')][nmask,ntime,:], Dvar['f1'][('/Budgets/RC','SEDI')][nmask,ntime,:], Dvar['f1'][('/Budgets/RC','DEPI')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RC','BERFI')][nmask,ntime,:], Dvar['f1'][('/Budgets/RC','IMLT')][nmask,ntime,:]
         ]
LaxeZ = [Dvar['f1']['mask_level']]*len(Lplot)
Ltitle = ['Bilan rapport en eau nuageuse : partie convective - MASK1']*len(Lplot)
Llinelabel = ['AUTO','ACCR','RIM','DRYG','SEDI','DEPI','BERFI','IMLT']
Lxlim = [(-0.25E-5, 0.25E-5)]*len(Lplot)
Lxlab = ['Terme du bilan ($s^{-1}$)']*len(Lplot)
Lylab = ['altitude (m)']*len(Lplot)
Lylim = [(0,12000.0)]*len(Lplot)
...
Lplot = [Dvar['f1'][('/Budgets/RR','AUTO')][nmask,ntime,:], Dvar['f1'][('/Budgets/RR','ACCR')][nmask,ntime,:], Dvar['f1'][('/Budgets/RR','REVA')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RR','DRYG')][nmask,ntime,:], Dvar['f1'][('/Budgets/RR','GMLT')][nmask,ntime,:], Dvar['f1'][('/Budgets/RR','ACC')][nmask,ntime,:]
         ]
LaxeZ = [Dvar['f1']['mask_level']]*len(Lplot)
Ltitle = ['Bilan rapport d\'eau précipitante : partie convective - MASK1']*len(Lplot)
Llinelabel = ['AUTO','ACCR','REVA','DRYG','GMLT','ACC']
...
Lplot = [Dvar['f1'][('/Budgets/RI','AGGS')][nmask,ntime,:], Dvar['f1'][('/Budgets/RI','AUTS')][nmask,ntime,:], Dvar['f1'][('/Budgets/RI','CFRZ')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RI','IMLT')][nmask,ntime,:], Dvar['f1'][('/Budgets/RI','DEPI')][nmask,ntime,:], Dvar['f1'][('/Budgets/RI','BERFI')][nmask,ntime,:]
         ]
LaxeZ = [Dvar['f1']['mask_level']]*len(Lplot)
Ltitle = ['Bilan rapport de mélange en glace : partie convective - MASK1']*len(Lplot)
Llinelabel = ['AGGS','AUTS','CFRZ','IMLT','DEPI','BERFI']
...
Lplot = [Dvar['f1'][('/Budgets/RS','AGGS')][nmask,ntime,:], Dvar['f1'][('/Budgets/RS','AUTS')][nmask,ntime,:], Dvar['f1'][('/Budgets/RS','ACC')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RS','CMEL')][nmask,ntime,:], Dvar['f1'][('/Budgets/RS','DEPS')][nmask,ntime,:], Dvar['f1'][('/Budgets/RS','RIM')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RS','DRYG')][nmask,ntime,:]
         ]
LaxeZ = [Dvar['f1']['mask_level']]*len(Lplot)
Ltitle = ['Bilan rapport de mélange de neige : partie convective - MASK1']*len(Lplot)
Llinelabel = ['AGGS','AUTS','ACC','CMEL','DEPS','RIM','DRYG']
Lxlim = [(-0.2E-5, 0.2E-5)]*len(Lplot)
Lxlab = ['Terme du bilan ($s^{-1}$)']*len(Lplot)
Lylab = ['altitude (m)']*len(Lplot)
Lylim = [(0,12000.0)]*len(Lplot)
...
Lplot = [Dvar['f1'][('/Budgets/RG','DEPG')][nmask,ntime,:], Dvar['f1'][('/Budgets/RG','ACC')][nmask,ntime,:], Dvar['f1'][('/Budgets/RG','CFRZ')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RG','CMEL')][nmask,ntime,:], Dvar['f1'][('/Budgets/RG','WETG')][nmask,ntime,:], Dvar['f1'][('/Budgets/RG','GMLT')][nmask,ntime,:],
         Dvar['f1'][('/Budgets/RG','RIM')][nmask,ntime,:], Dvar['f1'][('/Budgets/RG','DRYG')][nmask,ntime,:]
         ]
LaxeZ = [Dvar['f1']['mask_level']]*len(Lplot)
Ltitle = ['Bilan rapport en graupel : partie convective - MASK1']*len(Lplot)
Llinelabel = ['DEPG','ACC','CFRZ','CMEL','WETG','GMLT','RIM','DRYG']
Lxlim = [(-0.3E-5, 0.3E-5)]*len(Lplot)
Lxlab = ['Terme du bilan ($s^{-1}$)']*len(Lplot)
Lylab = ['altitude (m)']*len(Lplot)
Lylim = [(0,12000.0)]*len(Lplot)
