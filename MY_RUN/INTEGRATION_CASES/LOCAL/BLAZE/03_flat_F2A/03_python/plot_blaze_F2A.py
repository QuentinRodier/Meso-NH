...
LnameFiles = ['BLAZE.1.TEST3.002.nc']
...
Dvar = {}
Dvar = read_MNHfile.read_netcdf(LnameFiles, Dvar_input, path=path, removeHALO=True)

################################################################
#########          PANEL 1
###############################################################
Panel1 = Panel_Plot.PanelPlot(2,2, [25,15],'K=1', titlepad=25, minmaxpad=1.04, timepad=-0.07, colorbarpad=0.01)
...
Panel1 = Panel_Plot.PanelPlot(2,2, [25,15],'K=28', titlepad=25, minmaxpad=1.04, timepad=-0.07, colorbarpad=0.01)
...
Panel1 = Panel_Plot.PanelPlot(3,3, [25,15],'', titlepad=25, minmaxpad=1.04, timepad=-0.07, colorbarpad=0.01)
...
LaxeX = [Dvar['f1']['ni']]*len(Lplot)
LaxeY = [Dvar['f1']['nj']]*len(Lplot)
Ltitle = [ 'FMROS','FMASE available H','FMAWC available rl','FMFLUXHDH','FMFLUXHDW','FMWINDU','FMWINDV','FMWINDW','FMBMAP']
