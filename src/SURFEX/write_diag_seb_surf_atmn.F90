...
!     #########
      SUBROUTINE WRITE_DIAG_SEB_SURF_ATM_n (DTCO, DGO, D, DC, U, HGRID,KDIAG_TSTEP, HPROGRAM)
!     #################################
!
...
!!      J. Wurtz     10/22 Bugfix : dividing by number of timesteps for mean
!-------------------------------------------------------------------------------
!
!*       0.    DECLARATIONS
!              ------------
...
IF (DGO%N2M>=1) THEN
  ...
  YCOMMENT='X_Y_'//YRECFM//' (K)'
  PRINT *, KDIAG_TSTEP
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XT2M_MEAN(:)/KDIAG_TSTEP,IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='Q2M'
  ...
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XQ2M_MEAN(:)/KDIAG_TSTEP,IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='HU2M'
  YCOMMENT='X_Y_'//YRECFM//' (-)'
  ...
  YRECFM='HU2MMEA'
  YCOMMENT='X_Y_'//YRECFM//' (-)'
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XHU2M_MEAN(:)/KDIAG_TSTEP,IRESP,HCOMMENT=YCOMMENT)
  !
  IF ( SUM_ON_ALL_PROCS(HPROGRAM,HGRID,D%XZON10M(:)/= XUNDEF) > 0. ) THEN
    ...
    YRECFM='ZON10MMEA'
    YCOMMENT='X_Y_'//YRECFM//' (M/S)'
    CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XZON10M_MEAN(:)/KDIAG_TSTEP,IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='MER10MMEA'
    YCOMMENT='X_Y_'//YRECFM//' (M/S)'
    CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XMER10M_MEAN(:)/KDIAG_TSTEP,IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='W10MMEA'
    YCOMMENT='X_Y_'//YRECFM//' (M/S)'
    CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XWIND10M_MEAN(:)/KDIAG_TSTEP,IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='W10MMAX'
    YCOMMENT='X_Y_'//YRECFM//' (M/S)'
