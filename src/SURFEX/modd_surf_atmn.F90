...
INTEGER, POINTER :: NIMAX_SURF_ll=>NULL()
!$OMP THREADPRIVATE(NIMAX_SURF_ll)
INTEGER, POINTER :: NJMAX_SURF_ll=>NULL()
!$OMP THREADPRIVATE(NJMAX_SURF_ll)
INTEGER, POINTER :: NIMAX_SURF_LOC=>NULL()
!$OMP THREADPRIVATE(NIMAX_SURF_LOC)
INTEGER, POINTER :: NJMAX_SURF_LOC=>NULL()
!$OMP THREADPRIVATE(NJMAX_SURF_LOC)
...
NIMAX_SURF_ll=>SURF_ATM_MODEL(KTO)%NIMAX_SURF_ll
NJMAX_SURF_ll=>SURF_ATM_MODEL(KTO)%NJMAX_SURF_ll
NIMAX_SURF_LOC=>SURF_ATM_MODEL(KTO)%NIMAX_SURF_LOC
NJMAX_SURF_LOC=>SURF_ATM_MODEL(KTO)%NJMAX_SURF_LOC
...
SURF_ATM_MODEL(:)%NIMAX_SURF_ll=0
SURF_ATM_MODEL(:)%NJMAX_SURF_ll=0
SURF_ATM_MODEL(:)%NIMAX_SURF_LOC=0
SURF_ATM_MODEL(:)%NJMAX_SURF_LOC=0
