...
!
 ...
 CALL WRITE_SURF( YSC%DUO%CSELECT, HPROGRAM,'TOWN_TO_COVER',YSC%U%LTOWN_TO_COVER,IRESP,YCOMMENT)
 CALL WRITE_SURF( YSC%DUO%CSELECT, HPROGRAM,'REPLACE_COVER',YSC%U%NREPLACE_COVER,IRESP,YCOMMENT)
