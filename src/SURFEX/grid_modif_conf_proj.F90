...
!* number of points
!
IIMAX2=IXSIZE*IDXRATIO  !this is the global size of the son grid
IJMAX2=IYSIZE*IDYRATIO  !the local size is computed in REGULAR_GRID_SPAWN, and stored in IIMAX2, IJMAX2
!
KL2 = IIMAX2 * IJMAX2
!
