...
!     #########
      SUBROUTINE READ_DEFAULT_ISBA_n (CHI, MGN, DE, DGO, DMI, DUI, IO, HPROGRAM)
!     #######################################################
!
...
IF (LNAM_READ) THEN
 ...
 CALL POSNAM(ILUDES,'NAM_ISBA_CCN',GFOUND,ILUOUT)
 IF (GFOUND) READ(UNIT=ILUDES,NML=NAM_ISBA_CCn)
 CALL POSNAM(ILUDES,'NAM_ISBA_SNOWN',GFOUND,ILUOUT)
 IF (GFOUND) READ(UNIT=ILUDES,NML=NAM_ISBA_SNOWn) 
 CALL POSNAM(ILUDES,'NAM_ISBA_NUDGINGN',GFOUND,ILUOUT)
 IF (GFOUND) READ(UNIT=ILUDES,NML=NAM_ISBA_NUDGINGn)
ENDIF
