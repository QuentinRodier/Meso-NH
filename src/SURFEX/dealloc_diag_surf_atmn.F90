...
DO JT=1,NTILESFC
  ...
  !
  DEALLOCATE(ND%AL(JT)%XT2M_MEAN    )
  DEALLOCATE(ND%AL(JT)%XQ2M_MEAN    )
  DEALLOCATE(ND%AL(JT)%XHU2M_MEAN   )
  DEALLOCATE(ND%AL(JT)%XZON10M_MEAN )
  DEALLOCATE(ND%AL(JT)%XMER10M_MEAN )
  DEALLOCATE(ND%AL(JT)%XWIND10M_MEAN)
  DEALLOCATE(ND%AL(JT)%XWIFF_MEAN   )
  DEALLOCATE(ND%AL(JT)%XWIDD_MEAN   )
  !
  DEALLOCATE(ND%AL(JT)%XSWBD   )
  DEALLOCATE(ND%AL(JT)%XSWBU   )
  DEALLOCATE(ND%AL(JT)%XALB_DIR)
  DEALLOCATE(ND%AL(JT)%XALB_SCA)
  !
...
DEALLOCATE(D%XSFCO2  )
DEALLOCATE(D%XSFCO2ANT   )
DEALLOCATE(D%XSFCO2NAT   )
