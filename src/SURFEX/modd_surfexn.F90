...
USE MODD_TEB_HYDRO_OPTION_n, ONLY : TEB_HYDRO_OPTIONS_t
USE MODD_TEB_HYDRO_PGD_n, ONLY : TEB_HYDRO_PGD_t
USE MODD_TEB_HYDRO_n, ONLY : TEB_HYDRO_t, TEB_HYDRO_NP_t
...
TYPE(DATA_ISBA_t) :: DTV, DTHV
TYPE(ISBA_OPTIONS_t) :: O
TYPE(ISBA_S_t) :: S
TYPE(GR_BIOG_t) :: GB
TYPE(ISBA_K_t) :: K
TYPE(ISBA_P_t) :: P, PHV
TYPE(ISBA_NPE_t) :: NPE, NPEHV
!
...
TYPE(SPARTACUS_OPTIONS_t) :: SPAOP
TYPE(CANOPY_t) :: SB
TYPE(GRID_t) :: G
TYPE(CH_TEB_t) :: CHT 
...
!
TYPE TEB_HYDRO_MODEL_t
!
TYPE(DATA_TEB_HYDRO_t)    :: DTH
TYPE(TEB_HYDRO_OPTIONS_t) :: THO
TYPE(TEB_HYDRO_PGD_t)     :: THP
TYPE(TEB_HYDRO_NP_t)      :: NTH
!TYPE(ISBA_K_t)            :: K
!TYPE(ISBA_P_t)            :: P
!TYPE(ISBA_PE_t)           :: PE
!
END TYPE TEB_HYDRO_MODEL_t
!----------------------------------------------------------
!
TYPE SURFEX_t 
!
