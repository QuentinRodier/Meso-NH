...
!     #########
SUBROUTINE WRITE_DIAG_TOWN_n (DTCO, DUO, U, TM, GDM, GRM, HM, HPROGRAM,HWRITE)
!     ###############################################################################
!
...
USE MODD_SURFEX_n, ONLY : TEB_MODEL_t, TEB_GARDEN_MODEL_t,&  
                       TEB_GREENROOF_MODEL_t, TEB_HYDRO_MODEL_t,&
                       TEB_DIAG_t
...
IF (U%CTOWN=='TEB   ') THEN
  CALL WRITE_DIAG_TEB_n(DTCO, DUO, U, TM, GDM, GRM, HM, HPROGRAM,HWRITE)
END IF
