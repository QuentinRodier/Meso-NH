...
REAL, DIMENSION(SIZE(XDATA_HC_ROOF,1),SIZE(XDATA_HC_ROOF,2)) :: ZDATA_HC_ROOF,ZDATA_HC_WALL
REAL, DIMENSION(SIZE(XDATA_HC_ROAD,1),SIZE(XDATA_HC_ROAD,2)) :: ZDATA_HC_ROAD
