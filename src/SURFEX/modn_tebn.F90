...
CHARACTER(LEN=4)  :: CZ0EFF_GD
CHARACTER(LEN=5)  :: CCH_BEM
CHARACTER(LEN=4)  :: CURB_LM
CHARACTER(LEN=3)  :: CSOLAR_PANEL
!
REAL              :: XTSTEP
REAL              :: XOUT_TSTEP
REAL              :: XDIAG_TSTEP
...
NAMELIST/NAM_TEBn/CZ0H,CCH_BEM,CURB_LM,CZ0EFF_GD
NAMELIST/NAM_TEB_PANELn/CSOLAR_PANEL
!
CONTAINS
!
...
!
SUBROUTINE INIT_NAM_TEBn (T, TOP, TPN)
!
...
!
  ...
  TOP%CZ0H = CZ0H
  TOP%CZ0EFF_GD = CZ0EFF_GD
  TOP%CCH_BEM = CCH_BEM
  TOP%CURB_LM = CURB_LM  
  TPN%CSOLAR_PANEL = CSOLAR_PANEL
