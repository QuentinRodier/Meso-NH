...
!     #########
      SUBROUTINE WRITE_NATURE_n (DTCO, HSELECT, OSNOWDIMNC, U, IM, NDST,HPROGRAM,HWRITE)
!     ####################################
!
...
!       Modified    08/2016  R. Séférian : remove landuse key
!-------------------------------------------------------------------------------
!
!*       0.    DECLARATIONS
!              ------------
...
IF (U%CNATURE=='ISBA' .OR. U%CNATURE=='TSZ0') THEN
  CALL WRITE_ISBA_n(DTCO, HSELECT, OSNOWDIMNC, U, IM, NDST, HPROGRAM, HWRITE)
END IF
!
