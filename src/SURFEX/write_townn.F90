...
!     #########
      SUBROUTINE WRITE_TOWN_n (DTCO, HSELECT, OSNOWDIMNC, U, TM, GDM, GRM, HM, HPROGRAM, HWRITE)
!     ####################################
!
...
IF (U%CTOWN=='TEB   ') THEN
  CALL WRITE_TEB_n(DTCO, HSELECT, OSNOWDIMNC, U, TM, GDM, GRM, HM, HPROGRAM,HWRITE)
END IF
