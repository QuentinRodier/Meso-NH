...
!     #########
SUBROUTINE PREP_TOWN (DTCO, UG, U, USS, GCP, TM, GDM, GRM, HM, NPAR_VEG_IRR_USE, &
...
IF (U%CTOWN=='TEB   ') THEN
  CALL PREP_TEB(DTCO, UG, U, USS, GCP, TM%TOP, TM%BOP, TM%NB, TM%G, TM%SB, TM%NT, GDM, GRM, HM, NPAR_VEG_IRR_USE, &
                     HPROGRAM,HATMFILE,HATMFILETYPE,HPGDFILE,HPGDFILETYPE,YDCTL)
END IF
