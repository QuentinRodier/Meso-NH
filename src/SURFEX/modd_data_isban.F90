...
!!      J. Etchanchu   01/2018 : Add of irrigation variable
!!      A. Druel       02/2019 : Add other parameters for irrigation (and patch duplication)
!!      B. Decharme    08/2021 : Add LIMP_H_VEG
!!
!
!*       0.   DECLARATIONS
!             ------------
...
!                                                  ! each grid mesh                          (-)
  REAL, POINTER, DIMENSION(:,:)  :: XPAR_VEGTYPE2
!
!-------------------------------------------------------------------------------
!
  INTEGER                       :: NVEGTYPE
...
!
  ...
  LOGICAL, POINTER, DIMENSION(:)   :: LDATA_F2THRESHOLD
...
!
  ...
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_SEED_S2_M
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_SEED_S2_D
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_REAP_S2_M
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_REAP_S2_D
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_SEED_S3_M
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_SEED_S3_D
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_REAP_S3_M
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_REAP_S3_D
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_IRRIGTYPE
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_IRRIGTIME
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_IRRIGFRAC
  LOGICAL, DIMENSION(MAX(NVEGTYPE_OLD,NVEGTYPE_ECOSG))   :: LDATA_IRRIGFREQ
!
...
!
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_IRRIGTYPE
  REAL, POINTER, DIMENSION(:,:,:)   :: XPAR_WATSUP
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_IRRIGFRAC
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_IRRIGFREQ
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_IRRIGTIME
  REAL, POINTER, DIMENSION(:,:,:)   :: XPAR_F2THRESHOLD
  ...
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_SEED_S2_M
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_SEED_S2_D
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_REAP_S2_M
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_REAP_S2_D
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_SEED_S3_M
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_SEED_S3_D
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_REAP_S3_M
  REAL, POINTER, DIMENSION(:,:)     :: XPAR_REAP_S3_D
  INTEGER, POINTER, DIMENSION(:)    :: NPAR_VEG_IRR_USE
  CHARACTER(LEN=40),DIMENSION(:,:), POINTER :: CPATCH_NAME    ! Liste of the PATCH names (dim 1: patch name, dim 2: vegtype inside (True / False)
...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XPAR_ALB_HVEG         ! albedo of high vegetation
  REAL, POINTER, DIMENSION(:)   :: XPAR_HTRUNK_HVEG      ! height of trunk of trees
  REAL, POINTER, DIMENSION(:)   :: XPAR_WCROWN_HVEG      ! width of crown of trees
!
...
IF (LHOOK) CALL DR_HOOK("MODD_DATA_ISBA_N:DATA_ISBA_INIT",0,ZHOOK_HANDLE)
  ...
  NULLIFY(YDATA_ISBA%XPAR_VEGTYPE2)
  ...
  NULLIFY(YDATA_ISBA%XPAR_IRRIGTYPE)
  NULLIFY(YDATA_ISBA%XPAR_WATSUP)
  NULLIFY(YDATA_ISBA%XPAR_IRRIGFRAC)
  NULLIFY(YDATA_ISBA%XPAR_IRRIGFREQ)
  NULLIFY(YDATA_ISBA%XPAR_IRRIGTIME)
  NULLIFY(YDATA_ISBA%XPAR_F2THRESHOLD)
  NULLIFY(YDATA_ISBA%XPAR_SEED_M)
  NULLIFY(YDATA_ISBA%XPAR_SEED_D)
  NULLIFY(YDATA_ISBA%XPAR_REAP_M)
  NULLIFY(YDATA_ISBA%XPAR_REAP_D)
  NULLIFY(YDATA_ISBA%XPAR_SEED_S2_M)
  NULLIFY(YDATA_ISBA%XPAR_SEED_S2_D)
  NULLIFY(YDATA_ISBA%XPAR_REAP_S2_M)
  NULLIFY(YDATA_ISBA%XPAR_REAP_S2_D)
  NULLIFY(YDATA_ISBA%XPAR_SEED_S3_M)
  NULLIFY(YDATA_ISBA%XPAR_SEED_S3_D)
  NULLIFY(YDATA_ISBA%XPAR_REAP_S3_M)
  NULLIFY(YDATA_ISBA%XPAR_REAP_S3_D)
  NULLIFY(YDATA_ISBA%NPAR_VEG_IRR_USE)
  NULLIFY(YDATA_ISBA%CPATCH_NAME) 
  ...
  NULLIFY(YDATA_ISBA%XPAR_ALB_HVEG)
  NULLIFY(YDATA_ISBA%XPAR_HTRUNK_HVEG)
  NULLIFY(YDATA_ISBA%XPAR_WCROWN_HVEG)
...
NULLIFY(YDATA_ISBA%LDATA_F2THRESHOLD)
!
...
YDATA_ISBA%LDATA_SEED_S2_M(:) = .FALSE.
YDATA_ISBA%LDATA_SEED_S2_D(:) = .FALSE.
YDATA_ISBA%LDATA_REAP_S2_M(:) = .FALSE.
YDATA_ISBA%LDATA_REAP_S2_D(:) = .FALSE.
YDATA_ISBA%LDATA_SEED_S3_M(:) = .FALSE.
YDATA_ISBA%LDATA_SEED_S3_D(:) = .FALSE.
YDATA_ISBA%LDATA_REAP_S3_M(:) = .FALSE.
YDATA_ISBA%LDATA_REAP_S3_D(:) = .FALSE.
YDATA_ISBA%LDATA_IRRIGTYPE(:) = .FALSE.
YDATA_ISBA%LDATA_IRRIGTIME(:) = .FALSE.
YDATA_ISBA%LDATA_IRRIGFRAC(:) = .FALSE.
YDATA_ISBA%LDATA_IRRIGFREQ(:) = .FALSE.
!
