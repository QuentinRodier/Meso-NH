...
USE MODD_RAIN_ICE_DESCR,  ONLY : XALPHAC_I=>XALPHAC, XNUC_I=>XNUC, XALPHAR_I=>XALPHAR, XNUR_I=>XNUR,         &
                                 ...
                                 XCEXVT_I=>XCEXVT
USE MODD_RAIN_ICE_PARAM,  ONLY : XGAMINC_BOUND_MIN_I=>XGAMINC_BOUND_MIN, XGAMINC_BOUND_MAX_I=>XGAMINC_BOUND_MAX, &
