...
CFLAGS   += -g
#workaround for ifx 2023.0.0 bug with -CB / -fbounds-check (bug CMPLRLLVM-45802)
OBJS_NOBOUNDSCHECK = spll_upstream_z.o
$(OBJS_NOBOUNDSCHECK) : OPT = $(OPT_BASE) $(OPT_PERF0) -ftrapuv -debug-parameters all
endif
ifeq "$(OPTLEVEL)" "O2"
OPT       = $(OPT_BASE) $(OPT_PERF2)
OPT0      = $(OPT_BASE) $(OPT_PERF0)
