...
INTEGER :: I
REAL,DIMENSION(2) :: CNTRL
REAL, DIMENSION(NOTHER) :: OTHER
CHARACTER(LEN=15) :: SCASI
REAL, DIMENSION(NCOMP) :: WI, WT
REAL, DIMENSION(NGASAQ) :: GAS
REAL, DIMENSION(NSLDS) :: AERSLD
REAL, DIMENSION(NIONS+NGASAQ+2) :: AERLIQ
REAL :: RHI,TEMPI
