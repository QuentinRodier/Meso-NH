...
REAL         :: XN0IMIN    = 1.E6      ! minimum particule number value for I mode / m3
REAL         :: XN0JMIN    = 0.01E6    ! minimum particule number value for J mode / m3
REAL         :: XINIRADIUSI= 0.039     ! mean radius initialization for I mode (um)
REAL         :: XINIRADIUSJ= 0.321     ! mean radius initialization for J mode (um)
...
REAL         :: XCOEFRADIMIN  = 3.    ! maximum decreasement for Rg mode I
