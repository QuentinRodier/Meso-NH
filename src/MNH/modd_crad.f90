...
!    ########################
!
!!****  *MODD_CRAD* - Declaration of the constante for the cloud optical
!properties computation
!!
!!    PURPOSE
!!    -------
!       Declaration of the constante use in optical propertie
!       parameterizations which are not purpose by europeen center
!       
...
!!       - 1D Arrays to store the constante of the parameterization of the 
!        SW cloud optical properties for each of the 6 SW bands
!!       - 1D Arrays to store the constante of the parameterization of the 
!        LW cloud emissivity for each of the 16 spectral bands of the RRTM scheme
!!
!-------------------------------
!
!*       0.   DECLARATIONS
...
IMPLICIT NONE
!***************************************
! 1- declaration of indices of refraction for the
...
!
!***************************************
! 2- declaration of constante of the parameterization of the 
!        SW cloud optical properties for each of the 6 SW bands
!***************************************
! Water cloud optical thickness - Savi (1997)
REAL,DIMENSION(6)::XSWSAVIA=(/1.5,1.5,1.5,1.5,1.5,1.5/)
REAL,DIMENSION(6)::XSWSAVIB=(/0.5,0.5,0.5,0.78,1.13,2.0 /)

!***************************************
! 3- declaration of constante of the parameterization of the 
!        SW cloud optical properties for each of the 6 SW bands
!***************************************
REAL,DIMENSION(16,4)::XLWC2R2   !Longwave parametrisation make with the size
                                !distribution hypothesis of the 2 moment 
                                !scheme of Meso-NH  
REAL,DIMENSION(16,5)::XLWLILI   !Correction of the Linder and Li (2000) parameterisation implement 
                                ! in the ECMWF scheme 
REAL,DIMENSION(16,2)::XLWSAVI   !Savijarvi (1997) parameterisation
                                !different of constante use in the ECMWF scheme                             
                                   
END MODULE MODD_CRAD
