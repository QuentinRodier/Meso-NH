...
INTEGER, PARAMETER :: NSOA=10      ! number of condensable species that may form
                                   ! secondary aerosols
INTEGER, PARAMETER :: JP_AER_SOA1 = 8
INTEGER, PARAMETER :: JP_AER_SOA2 = 9
INTEGER, PARAMETER :: JP_AER_SOA3 = 10
INTEGER, PARAMETER :: JP_AER_SOA4 = 11
INTEGER, PARAMETER :: JP_AER_SOA5 = 12
INTEGER, PARAMETER :: JP_AER_SOA6 = 13
INTEGER, PARAMETER :: JP_AER_SOA7 = 14
INTEGER, PARAMETER :: JP_AER_SOA8 = 15
INTEGER, PARAMETER :: JP_AER_SOA9 = 16
INTEGER, PARAMETER :: JP_AER_SOA10 = 17
                                  ! Dusts
