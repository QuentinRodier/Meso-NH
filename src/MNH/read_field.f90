...
!
!
CALL INI_LS(TPINIFILE%CNAME,HLUOUT,HGETRVT,GLSOURCE,PLSUM,PLSVM,PLSWM,PLSTHM,PLSRVM)
!
!
!*       2.2b  2D "surfacic" LB fields   
!
!
CALL INI_LB(TPINIFILE%CNAME,HLUOUT,GLSOURCE,ISV,                      &
...
YDIR='--'
CALL FMREAD(TPINIFILE%CNAME,YRECFM,HLUOUT,YDIR,PDRYMASST,IGRID,ILENCH,YCOMMENT,IRESP)
!
