...
C     WORK IS AN AREA OF SIZE (N+1)*MIN(ILOT,LOT)
...
C
     ...
     *    ILA,IERR)
      IMPLICIT LOGICAL (L)
CCSB  REAL A(*),B(*),C(*),D(*),TRIGS(N*JP_NFFTCR)
      REAL A(*),B(*),C(*),D(*),TRIGS(*)
C
...
C              1 - ILOT GREATER THAN 1020
C              2 - IFAC NOT CATERED FOR
C              3 - IFAC ONLY CATERED FOR IF ILA=N/IFAC
C
C-----------------------------------------------------------------------
C
      REAL A10(1020),A11(1020),A20(1020),A21(1020),
     *    B10(1020),B11(1020),B20(1020),B21(1020)
C
...
C
     ...
     *    ILA,IERR)
      IMPLICIT LOGICAL (L)
CCSB  REAL A(*),B(*),C(*),D(*),TRIGS(N*NFFTCR)
      REAL A(*),B(*),C(*),D(*),TRIGS(*)
C
