...
!
IPROC = 21 + IRR + SIZE(TPFLYER%XSV,1) &
       + 2 + SIZE(TPFLYER%XSVW_FLUX,2)
IPROCZ = SIZE(TPFLYER%XRTZ,1) + SIZE(TPFLYER%XRZ,1) * SIZE(TPFLYER%XRZ,3) + SIZE(TPFLYER%XCRARE,1)+ &
         SIZE(TPFLYER%XCRARE_ATT,1)+ SIZE(TPFLYER%XWZ,1) + SIZE(TPFLYER%XFFZ,1)+ &
         SIZE(TPFLYER%XIWCZ,1)+ SIZE(TPFLYER%XLWCZ,1) + SIZE(TPFLYER%XCIZ,1) + &
         SIZE(TPFLYER%XZZ,1)

IF (NSV_LIMA_BEG<=NSV_LIMA_END) IPROCZ= IPROCZ+ SIZE(TPFLYER%XCCZ,1) + SIZE(TPFLYER%XCRZ,1)
