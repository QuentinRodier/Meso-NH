...
!
  ...
  INTEGER                        :: NCOM         ! comm row/col direction
  INTEGER, DIMENSION(:), POINTER :: NUMBER=>NULL()       ! zone's number  
...
!
!JUAN Z SPLITTING
  TYPE(MODELSPLITTING_ll),  DIMENSION(:),POINTER :: TSPLITS_SXP1_YP2_Z=>NULL()
...
!
!JUAN
  TYPE(LOCALISATION_ll), DIMENSION(:), POINTER :: TBOUND_SXP1_YP2_Z=>NULL() 
...
!JUAN Z SPLITTING
  TYPE(MODELSPLITTING_ll), POINTER :: TSPLIT_SXP1_YP2_Z=>NULL()
...
!JUAN
  ...
  TYPE(CRSPD_ll), POINTER  :: TSEND_SXP1_YP2_Z_SX_YP2_ZP1=>NULL(),&
                              TRECV_SXP1_YP2_Z_SX_YP2_ZP1=>NULL(),&
                              TSEND_SXP2_Y_ZP1_SXP1_YP2_Z=>NULL(),&
                              TRECV_SXP2_Y_ZP1_SXP1_YP2_Z=>NULL()
!JUAN MPIALLDATA
  ...
  TYPE(BOX_ll), POINTER    :: TSEND_BOX_SXP1_YP2_Z_SX_YP2_ZP1=>NULL(),&
                              TRECV_BOX_SXP1_YP2_Z_SX_YP2_ZP1=>NULL(),&
                              TSEND_BOX_SXP2_Y_ZP1_SXP1_YP2_Z=>NULL(),&
                              TRECV_BOX_SXP2_Y_ZP1_SXP1_YP2_Z=>NULL()
!JUAN MPIALLDATA
!JUAN
!
