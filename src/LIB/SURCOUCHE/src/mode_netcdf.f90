...
INTERFACE IO_WRITE_FIELD_NC4
   MODULE PROCEDURE IO_WRITE_FIELD_NC4_X3, IO_WRITE_FIELD_NC4_N0
...
SUBROUTINE IO_WRITE_FIELD_NC4_X3(TPFIELD,PZCDF,KRESP,PFIELD)
!
USE MODD_FM, ONLY : FMHEADER
USE MODD_IO_ll, ONLY : TFIELDDATA
!
...
SUBROUTINE IO_WRITE_FIELD_NC4_N0(TPFIELD,PZCDF,KRESP,KFIELD)
!
USE MODD_FM, ONLY : FMHEADER
USE MODD_IO_ll, ONLY : TFIELDDATA
